          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-4 bg-[#181b2e] rounded-lg shadow-md py-6 justify-between min-h-[370px]">
              <div className="mx-auto space-y-2.5 ">
                <h3 className="text-xl font-semibold px-6">SyncSync</h3>
                ...
                <p className="px-5 ">
                  Frontend Developer for SignSync, a React web application
                  designed to collect video data for a sign language deep
                  learning project. The user interface was crafted using
                  TypeScript and Tailwind CSS. The application possesses
                  functionalities that allow users to make video recording,
                  video translation uploads, and unique features like video
                  replay and retake options. Additionally, an admin interface
                  was also created for text and video repository management and
                  approval workflows.
                </p>
              </div>
              <div className="flex gap-4 px-6">
                ...
                <Link
                  to="https://github.com/feyiamujo1/SignSync"
                  target="_blank"
            ...
            <div className="flex flex-col gap-4 bg-[#181b2e] rounded-lg shadow-md py-6 justify-between min-h-[370px]">
              <div className="mx-auto space-y-2.5 ">
                <h3 className="text-xl font-semibold px-6">Wurafadaka</h3>
                <hr className="border-[#000000] "></hr>
                <div className="flex gap-3 px-6 pt-1">
                  <p className="bg-[#464958] text-sm py-2 px-3 rounded-md">
                    ReactJs
                ...
                <p className="px-5 ">
                  Served as the frontend developer for the Wurafadaka e-commerce
                  website, built using TypeScript and Tailwind CSS. Successfully
                  translated and implemented the provided website design, while
                  incorporating TypeScript to improve code quality. Developed
                  dynamic web pages, implemented user authentication, improved
                  shopping cart functionality, integrated backend APIs, and
                  optimized the overall website performance.
                </p>
              </div>
              <div className="flex gap-4 px-6">
                {" "}
                {/* justify-between */}
                <Link
                  to="http://wurafadaka-a677c.web.app/"
                  target="_blank"
                  className="flex items-center gap-2 group cursor-pointer text-[#878b95] hover:text-white underline decoration-light_blue">
                  <svg
                    class="w-6 h-6 dark:opacity-50 opacity-70 group-hover:opacity-100"
        ...
        <div className="w-11/12 mx-auto space-y-9">
          ...
          <div className="space-y-3">
            <p className="w-fit text-base md:text-lg">
              As a developer, I understand the immersive nature of our work, and
              I'm sure you can relate. That's why I decided to incorporate some
              Dev jokes, sourced through the Dev Joke API. These jokes are not
              only entertaining but also adds a relatable touch, making it a
              perfect fit. 😎😉
            </p>
            <p className="w-fit text-base md:text-lg">
