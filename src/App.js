        ...
        <div className="w-11/12 min-h-screen mx-auto flex items-center items">
          ...
          <div className="space-y-3 md:w-4/6 relative">
            ...
            <p className="text-base md:text-lg">
              I specialize in creating responsive and user-friendly web solutions that make a high impact using <Link to="https://react.dev/" target="_blank" className="font-bold underline text-yellow decoration-light_blue hover:text-light_blue transition-all duration-300" >React</Link>. I'm passionate about bringing ideas to life and solving 
              problems through innovative design and development. 
            </p>
            <p onClick={() => aboutRef.current.scrollIntoView({ behavior: 'smooth'})} className="px-4 py-2.5 rounded-full w-fit font-semibold text-base md:text-lg cursor-pointer bg-yellow hover:bg-light_blue transition-all duration-300">
              Learn More 
            </p>
      ...
      <section  className="py-8 sm:py-10 md:py-12 border-b">
        <div className="w-11/12 mx-auto space-y-9">
          ...
          <div className="w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:flex gap-4">
            <div className="px-4 py-2.5 border rounded-full w-fit flex items-center justify-between gap-4 group font-semibold text-base md:text-lg hover:scale-110 transition-all duration-500 group hover:bg-light_blue hover:border-light_blue">
